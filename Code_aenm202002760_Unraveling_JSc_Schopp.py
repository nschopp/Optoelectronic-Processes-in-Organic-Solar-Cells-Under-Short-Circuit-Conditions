...
print( '\033[4m'+'A Simple Approach for Unraveling Optoelectronic Processes in Organic Solar Cells under Short‐Circuit Conditions' +'\033[0m')
print('N. Schopp, V. Brus*, J. Lee, G. C. Bazan, T.-Q. Nguyen*, Advanced Energy Materials 2020, DOI 10.1002/aenm.202002760')
...
savepath= " " #<----- your folder path, should end with '/'
    
layers 			= ['NS_Glassubstrate' , 'NS_ITO', 'NS_ZnO', 'NS_PCE10_COTIC-4F' , 'NS_MoOx' , 'NS_Ag']
...
matDir			= 'C:/Users/schop/Google Drive/OpticalModeling/TransferMatrix/matdata/Used for Unraveling Jsc project'	# materials data
...
path_EQE=""
path_AM15 = path_AM15=' '  #<----- your paths
